...
import Dd from '../public/Logo.svg'
   ...
   <footer className='h-[684px] w[1280px] p-[80px] flex flex-col gap-[80px]'>
        <div className='w-[1120px] h-[52px] flex flex-col gap-[80px]'>
            ...
            <div className='w-[1120px] h-[225px] flex gap-2 justify-between'>
                <div className='w-[250px] h-[40px]'><Image src={Dd}alt=''/></div>
                    ...
                    <div className='w-[250px] h-[225px] flex flex-col gap-[16px]'>
                        <p className='text-[16px] leading-24px] font-semibold'>AboutUs</p>
                    ...
                    <div className='h-[24px] flex justify-between'>
                        <div className='h-[21px] flex gap-[24px]'>
                           ...
                           <div className='flex w-[132px] h-[24px] items-center '>
                                  <div className='h-[24px] w-[24px] flex justify-center item-center mr-[12px]'><Image src={Facebook} alt=''/></div>
                                   <div className='h-[24px] w-[24px] flex justify-center items-center mr-[12px]'><Image src={Insta} alt=''/></div>
                                  <div className='h-[24px] w-[24px] flex justify-center items-center mr-[12px]'><Image src={Twitter} alt=''/></div>
                                  <div className='h-[24px] w-[24px] flex justify-center items-center '><Image src={LinkdIn} alt=''/></div>
                            </div>
                    </div>
                </div>
        </div>
